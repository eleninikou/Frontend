...
class Dashboard extends Component {
  ...
  //   this.props.dispatch(getProjectsByUser(token))
  // }
...
const mapDispatchToProps = dispatch => { 
  return { 
    getProjectsByUser: (id) => dispatch(getProjectsByUser(id)),
  }
}

export default connect(null, mapDispatchToProps)(withStyles(dashboardStyle)(Dashboard));
