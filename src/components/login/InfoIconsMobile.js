...
const InfoIconsMobile = () => {
    return (
      <GridContainer style={{ minHeight: '60vh'}}> 
        <GridItem xs={12} sm={12} md={12} style={{ margin: 'auto', padding: '0px'}}>
          <CardBody style={{ margin: 'auto'}}>
            <GridContainer > 
              <GridItem xs={12} sm={12} md={4} style={{ padding: '0px'}}>
                <Card>
                  <CardHeader>
                    <CardIcon color="info">
...
export default InfoIconsMobile;
